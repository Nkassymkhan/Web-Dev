...
export const products = [
  ...
  },
  {
    ...
    price: 750,
    description: 'A great phone with one of the best cameras',
    url: 'https://kaspi.kz/shop/p/apple-iphone-xr-64gb-chernyi-1004249/?c=750000000#!/item',
    rating: '✰✰✰✰✰',
    photo:
        'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/ha4/h29/31566262042654/apple-iphone-xr-64gb-black-1004249-1-Container.jpg',
    category: 'Smart-Techno',
    like: 0
  },
  {
